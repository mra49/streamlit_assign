...
def main_findings(df):
    ...
    finding1 = '''Finding 1: If players want to increase there career span at the top level,
             they have to adapt their style of play to occupy more defensive role which can be seen from the second scatter plot.'''
    finding2 = '''Finding 2: The best time to sell players is when they are approaching the 28 years mark since this 
